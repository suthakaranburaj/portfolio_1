      ...
      <div className="relative z-10 flex flex-col items-center gap-8 px-8 py-12 md:px-14 md:py-16 bg-black/20 rounded-3xl shadow-[0_0_30px_rgba(34,197,94,0.25)] border border-green-400 max-w-xl w-full">
        ...
        <Link href="/">
          <motion.button
            ...
            whileTap={{ scale: 0.96 }}
            className="px-8 py-3 bg-gradient-to-r from-green-400 to-blue-400 text-black font-bold rounded-xl shadow-lg hover:from-green-300 hover:to-blue-300 transition-all duration-300 text-lg mt-2 cursor-pointer"
          >
            Back to Home
          </motion.button>
        </Link>
