...
• Received recognition from mental health organizations`,
    ...
    },
    {
      ...
      date: "December 2022",
      team: "Mobile Masters",
      description: "Developed a cross-platform mobile app for sustainable living.",
      longDescription: `Our team created a comprehensive mobile application that helps users adopt sustainable living practices through gamification and community features.
...
• 40% increase in sustainable practices
• Featured in App Store and Google Play
• Partnership with environmental organizations`,
      image: "/project_3.png",
      category: "mobile",
      achievements: [
        "Won 3rd place and $3,000 prize",
        "10,000+ downloads in first month",
        "Featured in app stores",
        "Partnership with environmental NGOs"
      ],
      technologies: [
        "React Native", "Firebase", "Redux", "Native APIs",
        "Push Notifications", "Offline Storage", "Gamification"
      ]
    }
  ];
...
export default HackathonClient; 